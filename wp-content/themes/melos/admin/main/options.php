    ...
    Redux::setSection( $opt_name, array(
		...
		'fields'           => array(
			...
			array(
				...
				$thinkup_subtitle_customizer => __('Display image logo or site title.', 'redux-framework'),
...
//			),
    ...
    Redux::setSection( $opt_name, array(
		'title'      => __('Support', 'redux-framework'),
		'desc'       => __('For premium support direct from the theme developers, or advice on customizations please <a href="http://www.thinkupthemes.com/themes/melos/" target="_blank">upgrade</a> to Melos Pro or purchase a <a href="http://www.thinkupthemes.com/pricing/" target="_blank">Theme Subscription</a>.', 'redux-framework'),
		'icon'       => 'el el-user',
		'icon_class' => '',
