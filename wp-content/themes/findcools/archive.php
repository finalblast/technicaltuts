		...
		<div id="content">
			...
			<div id="main" <?php if(get_theme_mod('fcs_sidebar_archive') == true) : ?>class="fullwidth"<?php endif; ?>>
				...
				<div class="archive-box">
					...
					<?php
						if ( is_day() ) :
							echo _e( '<span>Daily Archives</span>', 'findcools' );
							printf( __( '<h1>%s</h1>', 'findcools' ), get_the_date() );

						elseif ( is_month() ) :
							echo _e( '<span>Monthly Archives</span>', 'findcools' );
							printf( __( '<h1>%s</h1>', 'findcools' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'findcools' ) ) );

						elseif ( is_year() ) :
							echo _e( '<span>Yearly Archives</span>', 'findcools' );
							printf( __( '<h1>%s</h1>', 'findcools' ), get_the_date( _x( 'Y', 'yearly archives date format', 'findcools' ) ) );

						else :
							_e( '<h1>Archives</h1>', 'findcools' );
