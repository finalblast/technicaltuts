<?php
add_action( 'customize_register', 'findcools_customize_register' );
function findcools_customize_register($wp_customize) {
	...
	class Customize_Findcools_Info extends WP_Customize_Control {
        public $type = 'info';
        public $label = '';
        ...
        public function render_content() {
            $dropdown = wp_dropdown_categories(
                array(
                    ...
                    'echo'              => 0,
                    'show_option_none'  => __( '&mdash; Select &mdash;', 'findcools' ),
                    'option_none_value' => '0',
                    'selected'          => $this->value(),
                )
            );
